...
public class RelatorioService {
    ...
    public String getE(double valor, double valorRateado, ArrayList<String> matriculas, int mes, int ano) throws ValidationException {
        int anoAtual = LocalDate.now().getYear();
        ...
        if(valorRateado>valor)
        {
            throw new ValidationException("Valor rateado não pode ser superior ao valor total.");
        }
